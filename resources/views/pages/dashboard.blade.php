                ...
                <div class="row d-block d-xl-flex align-items-center">
                    ...
                    <div class="col-12 col-xl-7 px-xl-0">
                        ...
                        <div class="small d-flex mt-1">
                            <div>Depuis le mois passé <svg class="icon icon-xs text-success" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    ...
                    <div class="col-12 col-xl-7 px-xl-0">
                        ...
                        <div class="small d-flex mt-1">
                            <div>Depuis le mois passé <svg class="icon icon-xs text-danger" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-12 px-0">
            <div class="card border-0 shadow">
                <div class="card-body">
                    ...
                    <p>Vous indique d'où proviennent vos clients, comme par le bouche à oreille, les affiches publicitaires, les réseaux sociaux
