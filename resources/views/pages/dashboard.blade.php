...
<div class="row">
  <div class="col-12 mb-4">
    <div class="card border-0 shadow" style="background-color: #c6f5d3">
      <div class="card-header d-sm-flex flex-row align-items-center flex-0">
        <div class="d-block mb-3 mb-sm-0">
          <div class="fs-5 fw-normal mb-2">Chiffre d'Affaires</div>
          <h2 class="fs-3 fw-extrabold">2 Millions CFA</h2>
        ...
        <div class="d-flex ms-auto">
          <a href="#" class="btn btn-secondary btn-sm me-2">Mois</a>
          <a href="#" class="btn btn-sm me-3">Semaine</a>
        </div>
      </div>
        ...
        <div class="row d-block d-xl-flex align-items-center">
          <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
            ...
            <div class="d-sm-none">
              ...
              <h3 class="fw-extrabold mb-1">3.400</h3>
            </div>
          </div>
          <div class="col-12 col-xl-7 px-xl-0">
            <div class="d-none d-sm-block">
              <h2 class="h6 text-gray-400 mb-0">Clients</h2>
              <h3 class="fw-extrabold mb-2">3.4K</h3>
            </div>
            ...
            <div class="small d-flex mt-1">
              <div>Depuis le mois passé <svg class="icon icon-xs text-success" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
      ...
      <div class="card-body">
        <div class="row d-block d-xl-flex align-items-center">
          <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
            ...
            <div class="d-sm-none">
              <h2 class="fw-extrabold h5">Revenus</h2>
              <h3 class="mb-1">27 M CFA</h3>
            </div>
          </div>
          <div class="col-12 col-xl-7 px-xl-0">
            <div class="d-none d-sm-block">
              <h2 class="h6 text-gray-400 mb-0">Revenus</h2>
              <h3 class="fw-extrabold mb-2">27 M CFA</h3>
            </div>
            <small class="d-flex align-items-center text-gray-500">
              Nov 1 - Déc 1,
              <svg class="icon icon-xxs text-gray-500 ms-2 me-1" fill="currentColor" viewBox="0 0 20 20"
            ...
            <div class="small d-flex mt-1">
              <div>Depuis le mois passé <svg class="icon icon-xs text-danger" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
      ...
      <div class="card-body">
        <div class="row d-block d-xl-flex align-items-center">
          <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
            ...
            <div class="d-sm-none">
              <h2 class="fw-extrabold h5"> Rendement</h2>
              <h3 class="mb-1">50.88%</h3>
            </div>
          </div>
          <div class="col-12 col-xl-7 px-xl-0">
            <div class="d-none d-sm-block">
              <h2 class="h6 text-gray-400 mb-0">Rendement </h2>
...
<div class="row">
  <div class="col-12 col-xl-8">
    <div class="row">
      ...
      <div class="col-12 col-xxl-6 mb-4">
        <div class="card border-0 shadow">
          <div class="card-header border-bottom d-flex align-items-center justify-content-between">
            <h2 class="fs-5 fw-bold mb-0">Membres d'équipe</h2>
            <a href="#" class="btn btn-sm btn-primary">Voir plus</a>
          </div>
          <div class="card-body">
      ...
      <div class="col-12 col-xxl-6 mb-4">
        <div class="card border-0 shadow">
          <div class="card-header border-bottom d-flex align-items-center justify-content-between">
            <h2 class="fs-5 fw-bold mb-0">Suivi des tâches</h2>
            <a href="#" class="btn btn-sm btn-primary">Voir plus</a>
          </div>
          <div class="card-body">
            <!-- Project 1 -->
              ...
              <div class="col">
                <div class="progress-wrapper">
                  <div class="progress-info">
                    <div class="h6 mb-0">Nourrir les lapins</div>
            ...
            <div class="row align-items-center mb-4">
              ...
              <div class="col">
                <div class="progress-wrapper">
                  <div class="progress-info">
                    <div class="h6 mb-0">Préparer les saillies</div>
            ...
            <div class="row align-items-center mb-4">
              ...
              <div class="col">
                <div class="progress-wrapper">
                  <div class="progress-info">
                    <div class="h6 mb-0">Nettoyer les cages</div>
            ...
            <div class="row align-items-center mb-3">
              ...
              <div class="col">
                <div class="progress-wrapper">
                  <div class="progress-info">
                    <div class="h6 mb-0">Réparer les abreuvoirs</div>
  ...
  <div class="col-12 col-xl-4">
    <div class="col-12 px-0 mb-4">
      <div class="card border-0 shadow">
        <div class="card-header d-flex flex-row align-items-center flex-0 border-bottom">
          <div class="d-block">
            <div class="h6 fw-normal text-gray mb-2">Ventes totales</div>
          ...
          <div class="d-block ms-auto">
            <div class="d-flex align-items-center text-end mb-2">
              ...
              <span class="fw-normal small">Octobre</span>
            </div>
            <div class="d-flex align-items-center text-end">
              <span class="dot rounded-circle bg-secondary me-2"></span>
              <span class="fw-normal small">Novembre</span>
            </div>
          </div>
        </div>
        <div class="card-body p-2">
    ...
    <div class="col-12 px-0">
      <div class="card border-0 shadow">
        <div class="card-body">
          <h2 class="fs-5 fw-bold mb-1">Acquisition Client</h2>
          <p>Vous indique d'où proviennent vos clients, comme par le bouche à oreille, les affiches publicitaires, les
            réseaux sociaux
            ou grâce à votre référencement sur internet.</p>
          <div class="d-block">
            <div class="d-flex align-items-center me-5">
              ...
              <div class="d-block">
                <label class="mb-0">Taux de conversion</label>
            ...
            <div class="d-flex align-items-center pt-3">
              ...
              <div class="d-block">
                <label class="mb-0">Nouvelles commandes</label>
                <h4 class="mb-0">967</h4>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="card-body bg-gray-800 text-white pt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <a class="github-button" href="https://github.com/themesberg/volt-bootstrap-5-dashboard"
        ...
        data-show-count="true" aria-label="Star themesberg/volt-bootstrap-5-dashboard on GitHub">Star</a>
    </div>
