      ...
      <div id="mating-form" class="card card-body border-0 shadow mb-4">
        <form action="" method="post">
            ...
            <div class="row my-4">
              <div class="col-lg-4 col-sm-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control uid female_uid" name="female_uid" id="female_uid"
                    placeholder="F-001" required>
              ...
              <div class="col-lg-4 col-sm-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control uid male_uid" name="male_uid" id="male_uid" placeholder="M-001"
                    required>
                  <div class="invalid-feedback">Cet identifiant est introuvable !</div>
                </div>
              </div>
              <div class="col-lg-4 col-sm-6">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control mating_input" name="mating_date" id="mating_date" type="date"
          ...
          <div style="float:right">
            <button type="button" id="addMatingField" class="btn btn-light" style="border-color: #374157">Ajouter
              +</button>&nbsp;
            <!-- -->
            <button type="button" id="submitMatingForm" name="matingForm" value="1"
              class="btn btn-gray-800">Enregistrer</button>
          </div>
        </form>
      </div>
    </div>
