                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <p class="modal-title" id="modalTitleNotify">Une incompréhension, une suggestion ?</p>
                            ...
                            <div class="modal-body">
                                <div class="py-3 text-center">
                                    ...
                                    <h2 class="h4 modal-title my-3">Contactez-nous par E-mail ou Whatsapp !</h2>
                                    <div class="d-flex justify-content-around ">
                                        ...
                                        <button class="btn btn-success d-flex align-items-center gap-1" type="button" style="color: white">
