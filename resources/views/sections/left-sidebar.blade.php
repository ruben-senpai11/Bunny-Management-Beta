    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item"><a href="#" class="nav-link"><span class="sidebar-icon"><img
                            src="{{ asset('assets/img/calendar.svg') }}" alt=""
                            style="max-height: 20px;max-width: 20px; margin-right: 8px;">
                ...
                <div class="multi-level collapse" role="list" id="submenu-app" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item"><a class="nav-link" href="../tables/datatables.html"><span
                                    ...
                                    class="sidebar-text">Planification</span></a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="../tables/datatables.html"><span
            ...
            <li class="nav-item"><span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    data-bs-toggle="collapse" data-bs-target="#submenu-pages"><span><span class="sidebar-icon"><img
                            ...
                            class="sidebar-text">Statistiques</span>
                ...
                <div class="multi-level collapse" role="list" id="submenu-pages" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item"><a class="nav-link" href="../examples/pricing.html"><span
                                    class="icon icon-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <ul class="flex-column nav">
                        <li class="nav-item"><a class="nav-link" target="_blank"
                                href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/components/accordions/"><span
                                    class="icon icon-sm"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                        ...
                        <li class="nav-item"><a class="nav-link" href="../components/buttons.html"><span
                                    class="icon icon-sm"><svg class="icon icon-xs me-2" fill="currentColor"
            ...
            <li class="nav-item"><span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    data-bs-toggle="collapse" data-bs-target="#submenu-transactions"><span><span
                            class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                ...
                                <path fill-rule="evenodd"
                                    ...
                                    clip-rule="evenodd"></path>
                            </svg></span><span class="sidebar-text">Transactions</span> </span><span
                        class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewbox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
