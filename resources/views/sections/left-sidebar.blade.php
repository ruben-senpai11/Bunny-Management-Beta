...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li
                class="nav-item {{\Route::currentRouteName() == 'list-bunny' ? 'active' : '' }} {{\Route::currentRouteName() == 'create-bunny' ? 'active' : '' }}">
            ...
            <li class="nav-item"><span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    data-bs-toggle="collapse" data-bs-target="#submenu-app"><span><span class="sidebar-icon"><svg
                                ...
                                <path fill-rule="evenodd"
                                    ...
                                    clip-rule="evenodd"></path>
                            </svg> </span><span class="sidebar-text">Reproductions</span> </span><span
                ...
                <div class="multi-level collapse {{\Route::currentRouteName() == 'planifications' || \Route::currentRouteName() == 'matings' || \Route::currentRouteName() == 'palpations'|| \Route::currentRouteName() == 'gestations' ? 'show' : '' }}"
                    role="list" id="submenu-app" aria-expanded="false">
                    <ul class="flex-column nav">
                        <!-- planifications -->
                        <li class="nav-item {{ \Route::currentRouteName() == 'planifications' ? 'active' : '' }}"><a
                                class="nav-link" href="#"><span class="sidebar-text-contracted">P</span> <span
                                    class="sidebar-text disabled">Planifications</span></a>
                        </li>
                        <li class="nav-item {{ \Route::currentRouteName() == 'matings' ? 'active' : '' }}"><a
                                class="nav-link" href="{{ route('matings', []) }}"><span
                        ...
                        <li class="nav-item {{ \Route::currentRouteName() == 'palpations' ? 'active' : '' }}"><a
                                class="nav-link" href="{{ route('palpations', []) }}"><span
                                    class="sidebar-text-contracted">P</span> <span
                                    class="sidebar-text">Palpations</span></a></li>
                        <li class="nav-item {{ \Route::currentRouteName() == 'gestations' ? 'active' : '' }}"><a
                                class="nav-link" href="{{ route('gestations', []) }}"><span
            ...
            <li class="nav-item">
                <span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    data-bs-toggle="collapse" data-bs-target="#submenu-transactions">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 18 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item"><span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    ...
                    </span><span class="link-arrow disabled "><svg class="icon icon-sm" fill="currentColor"
